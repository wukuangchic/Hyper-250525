  ...
  <main>
    ...
    <section>
      ...
      <ul>
        ...
        <li><code>buy/sell</code>, <code>both/sym</code>, or <code>query</code>. For ladder orders, use explicit options like <code>--for 5 -1000</code> or <code>--while 85000 +1000</code>.</li>
    ...
    <section>
      ...
      <ul>
        ...
        <li><code>both</code> / <code>sym</code> requires <code>--offset</code>. Positional <code>amount</code> is per side; <code>--total</code> splits evenly across the buy and sell legs. Actual notional may be slightly higher after exchange size rounding.</li>
