...
class GridAvgTests(unittest.TestCase):
    ...
    def test_panic_threshold_migrates_legacy_defaults_only(self) -> None:
        self.assertEqual(grid_panic_ratio_threshold({}), Decimal("60"))
        self.assertEqual(grid_panic_ratio_threshold({"panic_ratio_threshold": "10"}), Decimal("60"))
        self.assertEqual(grid_panic_ratio_threshold({"panic_ratio_threshold": "20"}), Decimal("60"))
        self.assertEqual(grid_panic_ratio_threshold({"panic_ratio_threshold": "30"}), Decimal("60"))
        self.assertEqual(grid_panic_ratio_threshold({"panic_ratio_threshold": "50"}), Decimal("60"))
